...
export default function Delay() {
  ...
  function dataloop(){
    ...
    return <>
      <Dataloop data={arrdata} pageroute={'delay'}></Dataloop>
    </>
  }
  ...
  return (
   <>
      <Body>
          ...
          <RightDesign data={dataloop()}  pageroute={"delay"} paginate={paginate()} searchfilter={search()}></RightDesign>
