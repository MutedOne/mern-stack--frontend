...
export default function done() {
  ...
  function dataloop(){
    ...
    return <>
      <Dataloop data={arrdata} pageroute={'done'}></Dataloop>
    </>
  }
  ...
  return (
   <>
      <Body>
          ...
          <RightDesign data={dataloop()}  pageroute={"done"} paginate={paginate()} searchfilter={search()}></RightDesign>
